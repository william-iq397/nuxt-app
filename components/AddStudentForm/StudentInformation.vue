            ...
            <div class="w-full flex flex-col justify-around items-center">
                ...
                <div class="w-full flex justify-end gap-4 ">
                    <div class="w-2/6">
                        ...
                        <select id="gender" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-4  dark:border-gray-400 dark:placeholder-gray-400 bg-transparent dark:focus:ring-blue-500 dark:focus:border-blue-500" v-model="store.student.gender">
                ...
                <div class="w-full flex justify-end gap-4 my-4 ">
                    <div class="w-2/6 h-full text-right">
                        <p>فصيلة الدم</p>
                        <select id="blood_type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-4  dark:border-gray-400 dark:placeholder-gray-400 bg-transparent dark:focus:ring-blue-500 dark:focus:border-blue-500" v-model="store.student.blood_type">
                            <option value="ذكر">ذكر</option>
                            <option value="انثى">انثى</option>
                        </select>
                    </div>
                    ...
                    <div class="w-2/6 h-full text-right">
                        ...
                        <select id="grade" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-4  dark:border-gray-400 dark:placeholder-gray-400 bg-transparent dark:focus:ring-blue-500 dark:focus:border-blue-500" v-model="store.student.grade">
                            <option value="ذكر">ذكر</option>
                            <option value="انثى">انثى</option>
                        </select>
                    </div>
                ...
                <div class="w-full flex justify-end gap-4 my-4 ">
                    <div class="w-2/6 h-full">
                        <div class="relative w-full flex flex-col text-right">
                            <p>نوع المرض</p>
                            <div class="relative w-full">
                                <input type="text" id="disease_type" class="text-right block rounded-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-400 bg-transparent border border-gray-400 appearance-none  dark:border-gray-400 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" v-model="store.student.disease_type" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-2/6 h-full flex flex-col text-right">
                        ...
                        <select id="does_student_has_disease" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-4  dark:border-gray-400 dark:placeholder-gray-400 bg-transparent dark:focus:ring-blue-500 dark:focus:border-blue-500" v-model="store.student.does_student_has_disease">
                    ...
                    <div class="w-2/6 h-full">
                        <div class="relative w-full text-right">
                            <p>مكان السكن</p>
                            <input type="text" id="residancy_place" class="text-right block rounded-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-400 bg-transparent border border-gray-400 appearance-none  dark:border-gray-400 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" v-model="store.student.residancy_place" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- input image field -->
             <div class="w-3/12 h-full flex flex-col justify-center my-4">
                ...
                <label for="student_image" class="relative mb-2 px-2 cursor-pointer w-full h-full py-8 border border-solid border-gray-400 rounded-lg flex justify-center items-center">
                    ...
                    <img v-if="store.student.student_id_photo" :src="store.student.student_id_photo" class="object-cover" alt="صورة الطالب">
                </label>
            </div>
        </div>
...
function handleImageUpload(event) {
  ...
  if (file) {
    ...
    if (file.type.startsWith('image/')) {
      // Create a temporary URL for the image and store it in imagePreview
      studentImage.value = URL.createObjectURL(file)
      store.student.student_id_photo = studentImage.value
    } else {
