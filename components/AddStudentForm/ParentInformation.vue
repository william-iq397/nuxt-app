<template>
    <div class="flex flex-col gap-8 w-full h-5/6 my-8" dir="rtl">
        <div>
        ...
        <div class="flex gap-4 w-full">
            <div class="w-2/6 h-full">
                <select required id="gender" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-4  dark:border-gray-400 dark:placeholder-gray-400 bg-transparent dark:focus:ring-blue-500 dark:focus:border-blue-500" v-model="store.student.relative_type" placeholder=" " >
        ...
        <div class="flex gap-4 w-full">
            ...
            <div class="w-2/6 h-full">
                <div class="relative w-full">
                    <input required type="text" id="father_profession" class="text-right block rounded-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-400 bg-transparent border border-gray-400 appearance-none  dark:border-gray-400 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" v-model="store.student.father_profession"  placeholder=" " />
        ...
        <div class="flex gap-4 w-full">
            <div class="w-2/6 h-full">
                <div class="relative w-full">
                    <textarea required v-model="store.student.note" id="note" class="resize-none text-right block rounded-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-400 bg-transparent border border-gray-400 appearance-none  dark:border-gray-400 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
